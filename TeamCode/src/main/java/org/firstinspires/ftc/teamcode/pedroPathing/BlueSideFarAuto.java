...
public class BlueSideFarAuto extends OpMode {
    ...
    // Poses
// Poses (mirrored for Blue side)
// Poses (mirrored left/right for Blue side)
    private final Pose startPose = new Pose(57, 9, Math.toRadians(90));
    private final Pose scorePose = new Pose(64, 90, Math.toRadians(136));
    private final Pose set3frontPose = new Pose(54, 38, Math.toRadians(180));
    private final Pose set3controlPoint = new Pose(64, 41);
    private final Pose set3pickPose = new Pose(5, 41, Math.toRadians(180));
    private final Pose moveOutPose = new Pose(134, 10, Math.toRadians(90));
    private final Pose a = new Pose(80,20);
    ...
    public void buildPaths() {
        ...
        scorePreload.setLinearHeadingInterpolation(Math.toRadians(90), Math.toRadians(138));
        ...
        scoreSet3 = follower.pathBuilder()
                .addPath(new BezierCurve(set3pickPose, a, scorePose))
    ...
    public boolean isShooterReady() {
        return Math.abs(currentRPM - TARGET_RPM) <= 150;
    }
