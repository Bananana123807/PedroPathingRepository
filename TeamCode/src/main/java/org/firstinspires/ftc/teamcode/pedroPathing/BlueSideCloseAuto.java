...
public class BlueSideCloseAuto extends OpMode {
    ...
    private static final double TARGET_RPM = 3300;
    ...
    // Poses
    // Mirrored poses (flip X across field center, assuming 144" field width)
// Poses (mirrored left/right for Blue side)
    private final Pose startPose = new Pose(19.5, 119.6, Math.toRadians(144));
    private final Pose scorePose = new Pose(43, 100, Math.toRadians(144));
    private final Pose shakePose = new Pose(43, 93, Math.toRadians(144));
    private final Pose set1frontPose = new Pose(54, 69, Math.toRadians(180));
    private final Pose set1controlPoint = new Pose(84, 90);
    private final Pose set1pickPose = new Pose(16, 64, Math.toRadians(180));
    private final Pose set2frontPose = new Pose(54, 39, Math.toRadians(180));
    private final Pose set2controlPoint = new Pose(74, 84);
    private final Pose set2pickPose = new Pose(15, 38, Math.toRadians(180));
    private final Pose set2OutPose = new Pose(54, 40, Math.toRadians(180));
    private final Pose moveOutPose = new Pose(24, 85, Math.toRadians(180));

    // Paths (same structure as RedSide)
    ...
    public void buildPaths() {
        ...
        scorePreload.setLinearHeadingInterpolation(Math.toRadians(144), Math.toRadians(135));
