...
//public class PewPewTeleOpAutomaticTesting extends LinearOpMode {
//
//    double targetRPM = 0;
//    double kP = 0.0007;
//    double kI = 0.0005;
...
//        encoderX = hardwareMap.get(CRServo.class, "intakeServo");
//        encoderY = hardwareMap.get(Servo.class, "server");
//
//
//
//
...
//
//        void updateOdometry() {
//            double currentX = encoderX.position(degrees);
//            double currentY = encoderY.position(degrees);
//
//            double deltaX = currentX - prevX;
//            double deltaY = currentY - prevY;
//
//            // Convert to inches (example values)
//            double xInches = deltaX / 360.0 * 2.75 * M_PI;
//            double yInches = deltaY / 360.0 * 2.75 * M_PI;
//
//            // Update global position (assuming no rotation)
//            xPos += xInches;
//            yPos += yInches;
//
//            prevX = currentX;
